...
public class Product_Adapter extends RecyclerView.Adapter<Product_Adapter.ProductViewHolder> {
    ...
    public Product_Adapter(Context context, List<Sale_Item> saleItemList) {
    ...
    public void onBindViewHolder(@NonNull ProductViewHolder holder, int position) {
        Sale_Item saleItem = saleItemList.get(position);
    ...
    private void addToCart(Sale_Item saleItem) {
        ...
        query.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                    Cart_Item cartItem = snapshot.getValue(Cart_Item.class);
                ...
                if (!productExists) {
                    ...
                    Cart_Item cartItem = new Cart_Item(cartItemId, productId, userId, 1,
    ...
    public void addReview(String productId) {
        ...
        submitReviewButton.setOnClickListener(v -> {
            ...
            Review_Activity review = new Review_Activity(reviewId, productId, userId, reviewText);
